...
import static com.ycrl.utils.gson.GsonUtils.wrapDataToEntity;
...
public class ResourceCtrl extends BaseController {
    ...
    public void myMenu(HttpServletRequest request, HttpServletResponse response) {
        // 用于未登录的游客
        // FIXME 这里其实应该查询所有不需要授权的资源
        if (StringUtils.isEmpty(SecurityContext.getEmpId())) {
            GsonUtils.printData(response, null);
            return;
        }
