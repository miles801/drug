...
public class AccreditMenuDaoImpl extends HibernateDaoHelper implements AccreditMenuDao {
    ...
    private Criteria getDefaultCriteria(AccreditMenuBo bo) {
        Criteria criteria = createPagerCriteria(AccreditMenu.class);
        initCriteria(criteria, bo);
        return criteria;
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<Resource> queryMenus(String[] deptIds) {
        if (deptIds == null || deptIds.length < 1) {
        ...
        return createCriteria(Resource.class)
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<Resource> queryMenus(String empId) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<Resource> queryAccreditMenuRoot(String userId) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<Resource> queryAccreditMenus(String userId, String systemMenuId) {
