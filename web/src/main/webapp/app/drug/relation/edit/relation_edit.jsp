...
<body >
<div class="main" ng-app="drug.relation.edit" ng-controller="Ctrl" >
    <div class="block" >
        <div class="block-header" >
                ...
                <span class="header-button" >
                    ...
                    <button type="button" class="btn btn-green btn-min" ng-click="save()" ng-disabled="form.$invalid" >
                        ...
                        <button type="button" class="btn btn-green btn-min" ng-click="save(true)" ng-disabled="form.$invalid" >
...
<select ng-model="beans.type" class="col-2-half" ng-options="foo.value as foo.name for foo in x">
</select >
                    </div >
                    <div class="row" >
<div class="form-label col-1-half" >
...
<select ng-model="beans.status" class="col-6-half" ng-options="foo.value as foo.name for foo in x">
</select >
                    </div >
                </form >
            </div >
...
<script type="text/javascript" src="<%=contextPath%>/app/drug/relation/edit/relation_edit.js" ></script>
</html >