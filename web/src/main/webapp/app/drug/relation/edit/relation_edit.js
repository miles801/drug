...
(function (window, angular, $) {
    var app = angular.module('drug.relation.edit', [
        'drug.relation',
        'eccrm.angular',
        'eccrm.angularstrap'
    ]);
    ...
    app.controller('Ctrl', function ($scope, CommonUtils, AlertFactory, ModalFactory, RelationService, RelationParam) {
        ...
        $scope.update = function () {
            var promise = RelationService.update($scope.beans, function (data) {
        ...
        $scope.load = function (id) {
            var promise = RelationService.get({id: id}, function (data) {
