...
(function (window, angular, $) {
    var app = angular.module('drug.drug.list', [
        'eccrm.angular',
        'eccrm.angularstrap',
        'eccrm.angular.ztree',
        'base.org',
    ...
    app.controller('Ctrl', function ($scope,OrgTree,ParameterLoader, CommonUtils, AlertFactory, ModalFactory, DrugService, DrugParam) {
        $scope.condition = { };
        // 导出数据
        $scope.exportData = function () {
            ...
            o.start = null;
            o.limit = null;
            window.open(CommonUtils.contextPathURL('/base/drug/exportDrugExcel ?' + encodeURI(encodeURI($.param(o)))));
        };
        ...
        $scope.pager = {
            fetch: function () {
                ...
                return CommonUtils.promise(function(defer){
                    var promise = DrugService.pageQuery(param, function(data){
                        param = null;
        ...
        $scope.remove = function (id) {
            ...
            ModalFactory.confirm({
                ...
                callback: function () {
                    var promise = DrugService.deleteByIds({ids: id}, function(){
