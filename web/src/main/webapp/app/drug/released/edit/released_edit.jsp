...
<body>
<div class="main" ng-app="drug.released.edit" ng-controller="Ctrl">
    <div class="block">
            ...
            <div class="content-wrap">
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3-half">
                            <input type="text" class="col-12" ng-model="beans.released.inStartTime" id="inStartTime"
                    ...
                    <div class="row">
                        ...
                        <input class="col-3-half" type="text" ng-model="beans.released.illegalType" maxlength="20"/>
                        <div class="form-label col-1-half">
                            <label>抓获地区</label>
                        </div>
                        <input class="col-3-half" type="text" ng-model="beans.released.area" maxlength="20"/>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-3-half">
                        <input type="text" class="col-12" ng-model="beans.released.releasedDate" id="releasedDate"
                               eccrm-my97="{el:'releasedDate',dateFmt:'yyyy-MM-dd HH:mm:ss'}"
                               readonly/>
                    ...
                    <div class="row">
                        ...
                        <input class="col-3-half" type="text" ng-model="beans.released.nowWork" maxlength="20"/>
                        <div class="form-label col-1-half">
                            <label>现从业地点</label>
                        </div>
                        <input class="col-3-half" type="text" ng-model="beans.released.nowWorkDress" maxlength="40"/>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <textarea class="col-8-half" rows="3" ng-model="beans.released.context"
...
<script type="text/javascript" src="<%=contextPath%>/app/drug/released/edit/released_edit.js"></script>
</html>