...
public class GenerateListAndEditPage
{
    ...
    public void setUp() throws Exception
    {
        ...
        root = "D:\\workspace\\lr\\itsm\\web\\src\\main\\webapp\\app\\";
    ...
    {
        Module module = new Module("asset", "assetGroup", "资产组");
    ...
    private void setListPage(Module module)
    {
        ...
        listPage.addQueryCondition(new Row("标题:label", "title", "关键字:label", "keywords"));
        listPage.addQueryBarButton("查询:search:query", "重置:repeat:reset");
        listPage.addTableHeaderButton("启用", "注销");
        listPage.addItem("审批名称", "申请人", "申请时间", "最近处理时间", "状态", "操作");
    ...
    private void setEditPage(Module module)
    {
        ...
        editPage.
                addFormRow("标题:label", "title:text:col-2-half", "类型:label", "type:select:col-2-half").
                addFormRow("内容:label", "content:textarea:col-6-half").
                addFormRow("关键字:label", "keywords:text:col-6-half").
                addFormRow("外部链接:label", "url:text:col-6-half").
                addFormRow("状态:label", "status:select:col-6-half");
